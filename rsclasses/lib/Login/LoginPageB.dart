...
import 'package:rsclasses/HomePage/HomePage.dart';
import 'package:rsclasses/Login/SignUpA.dart';
...
class _PhoneAuthVerifyState extends State<PhoneAuthVerify> {
  ...
  Future<void> signIn() async {
    ...
    await FirebaseAuth.instance.signInWithCredential(PhoneAuthProvider.credential(
      ...
      var muser = await FirebaseFirestore.instance.collection('Users').doc(widget.phone).collection('Account').doc('Profile').get();
      if(muser.exists){
        Fluttertoast.showToast(
            msg: "Logging In...",
            toastLength: Toast.LENGTH_SHORT,
        ...
        await pr.hide();
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (BuildContext context) => SignUp(widget.phone)));
      }
