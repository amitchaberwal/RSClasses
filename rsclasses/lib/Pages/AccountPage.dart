...
class _AccountPageState extends State<AccountPage> {
  ...
  Future uploadData(BuildContext context) async {
    ...
    if(_imageFile != null){
      ...
      await databaseReference.collection('Users').doc(uphone).collection('Account').doc('Profile').update(acData);
            ...
            children: [
              ...
              Center(
                child: Padding(
                  ...
                  child: Text(
                    acData['Name'],
                    style: TextStyle(color: Theme.of(context).secondaryHeaderColor,fontSize: 20.sp,fontWeight: FontWeight.w700),
                  ),
                ),
              ),
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 15.w,vertical: 10.h),
                child: TextFormField(
                  controller: TextEditingController(text: acData['Parent'],),
              ...
              Padding(
                padding:  EdgeInsets.symmetric(horizontal: 15.w,vertical: 10.h),
                child: TextField(
                  controller: TextEditingController(text: acData['Age'].toString(),),
                  keyboardType: TextInputType.number,
                  decoration: new InputDecoration(
                      border: new OutlineInputBorder(
                        borderSide: BorderSide.none,
